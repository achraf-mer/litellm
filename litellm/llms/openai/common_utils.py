...
class BaseOpenAILLM:
    ...
    @staticmethod
    def tls_client_kwargs(litellm_params: Optional[Mapping[str, object]]) -> OpenAITLSClientKwargs:
    ...
    def _get_async_http_client(
        ...
        ssl_config = BaseOpenAILLM._get_tls_config(ssl_verify, client_cert, client_key)
